                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <!-- <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Title" name="title">
                        </div> -->
<!-- Title prdct or category shuru -->
...
<div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="Description" name="res_code">
                                </div>
                            </div>
                        </div>
                        <div class="p-t-20">
